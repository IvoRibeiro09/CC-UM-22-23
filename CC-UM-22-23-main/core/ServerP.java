...
public class ServerP {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Logs log = new Logs();
        Cache ca = new Cache();
        String configfile = "files/SP.robalo.txt";
            ...
            while(true) {
                ...
                if(Objects.equals(aux[0], "QE")){
                    try {
                        ...
                        log.addFL(s.getInetAddress().getHostName(),"comunicação entre cliente e servidor primario");
                    }
                //servidor
                    ...
                    try {
                        ...
                        //Socket ns = new Socket(sp.get1SS(), 12347);
                        while (i > j) {
